...
//   // Reset to first page when causesPerPage changes
//   useEffect(() => {
//     setCurrentPage(1);
//   }, [causesPerPage]);
...
//     try {
//       await dispatch(
//         updateCauseStatusById({ id: selectedCause.showCauseId, status: newStatus })
//       ).unwrap();
...
//         {/* Header */}
//         <div className="bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-t-lg p-4 sm:p-6">
...
//                 <TableHead className="text-green-800 font-semibold py-3 sm:py-4 text-xs sm:text-sm">
//                   Cause ID
//                 </TableHead>
//                 <TableHead className="text-green-800 font-semibold py-3 sm:py-4 text-xs sm:text-sm">
//                   Meeting ID
...
//                   >
//                     <TableCell className="text-gray-700 text-xs sm:text-sm py-3 sm:py-4">
//                       {cause.showCauseId}
//                     </TableCell>
//                     <TableCell className="text-gray-700 text-xs sm:text-sm py-3 sm:py-4">
//                       {cause.meetingId}
...
//                         variant="outline"
//                         size="sm"
//                         className="border-green-500 text-green-600 hover:bg-green-100 hover:text-green-700 transition-colors duration-200 text-xs sm:text-sm"
...
//                   <TableCell
//                     colSpan={5}
//                     className="text-center text-gray-600 py-6 text-sm sm:text-base"
//                   >
//                     No causes found.
//                   </TableCell>
//                 </TableRow>
...
//         {/* Pagination */}
//         {totalPages > 1 && (
//           <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4 p-4 sm:p-6">
//             {/* Items per page selector */}
//             <div className="flex items-center space-x-2">
//               <Label htmlFor="causesPerPage" className="text-green-700">
//                 Causes per page:
//               </Label>
//               <Select
...
//             {/* Go to page input */}
//             <div className="flex items-center space-x-2">
//               <Label htmlFor="goToPage" className="text-green-700">
//                 Go to page:
//               </Label>
//               <Input
//                 id="goToPage"
...
//             <DialogContent className="sm:max-w-[90vw] md:max-w-[600px] bg-white rounded-xl border border-green-200 p-4 sm:p-6">
//               <DialogHeader>
//                 <DialogTitle className="text-xl sm:text-2xl font-semibold text-green-700 flex items-center">
...
//                 <div>
//                   <Label className="text-green-700 font-semibold text-sm sm:text-base">
//                     Meeting ID
//                   </Label>
//                   <Input
//                     value={selectedCause.meetingId}
//                     readOnly
//                     className="mt-1 border-green-400 bg-gray-50 text-gray-700 text-sm sm:text-base focus:ring-0 cursor-not-allowed"
//                   />
//                 </div>
//                 <div>
//                   <Label className="text-green-700 font-semibold text-sm sm:text-base">
...
//                     readOnly
//                     className="mt-1 border-green-400 bg-gray-50 text-gray-700 text-sm sm:text-base resize-none focus:ring-0 cursor-not-allowed"
//                     rows={4}
//                   />
//                 </div>
//                 <div>
...
//                     className="mt-1"
//                   >
//                     <SelectTrigger className="border-green-400 focus:ring-2 focus:ring-green-500 bg-gray-50 text-sm sm:text-base">
...
//                 <Button
//                   variant="outline"
//                   className="border-gray-500 text-gray-600 hover:bg-gray-100 hover:text-gray-700 transition-colors duration-200 text-sm sm:text-base"
//                   onClick={handleCloseModal}
//                 >
//                   Cancel
//                 </Button>
//                 <Button
//                   className="bg-green-600 hover:bg-green-700 text-white transition-all duration-200 text-sm sm:text-base"
