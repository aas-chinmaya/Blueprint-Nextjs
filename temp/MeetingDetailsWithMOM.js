...
//       const momData = {
//         ...momForm,
//         participants: momForm.participants?.split(',').map((p) => p.trim()) || '',
//         meetingId: meeting.meetingId,
//       };
//       if (isEditMode && mom) {
...
//       setIsEditMode(false);
//     } catch (error) {
//       toast.error(`Failed to ${isEditMode ? 'update' : 'create'} MoM`);
//     }
//   };
...
//     } else {
//       toast.error('No MoM attachment available');
//     }
//   };
...
//         meetingMode: mom.meetingMode || meeting?.meetingMode || 'Online',
//         duration: mom.duration || getDurationString() || '',
//         participants: Array.isArray(mom.participants) ? mom.participants.join(', ') : getAttendeesString(mom.participants) || '',
//         summary: mom.summary || '',
//         notes: mom.notes || '',
//         createdBy: mom.createdBy || '',
//         meetingId: meeting?.meetingId || '',
...
//           {mom && !isEditMode ? 'Meeting Details' : isEditMode ? 'Edit Minutes of Meeting' : 'Create Minutes of Meeting'}
//         </DialogTitle>
//       </DialogHeader>
...
//               <h4 className="font-medium text-green-800">Minutes of Meeting</h4>
//               <Button
//                 variant="outline"
...
//             </p>
//             <p className="text-green-700">
//               <strong>Meeting Mode:</strong> {meeting.meetingMode || 'N/A'}
//             </p>
//             <p className="text-green-700">
//               <strong>Duration:</strong> {meeting.duration || 'N/A'}
//             </p>
//             <p className="text-green-700">
//               <strong>Participants:</strong> {Array.isArray(meeting.participants) ? meeting.participants.join(', ') : getAttendeesString(mom.participants) || 'None'}
//             </p>
//             <p className="text-green-700">
//               <strong>Summary:</strong> {meeting.summary || 'N/A'}
//             </p>
//             <p className="text-green-700">
//               <strong>Notes:</strong> {meeting.notes || 'N/A'}
//             </p>
//             <p className="text-green-700">
//               <strong>Created By:</strong> {mom.createdBy || 'N/A'}
//             </p>
//             <p className="text-green-700">
//               <strong>Meeting Date:</strong> {meeting.date || 'N/A'}
//             </p>
//             <Button
//               variant="outline"
...
//               <MessageSquare className="h-5 w-5 mr-2" /> Agenda
//             </Label>
//             <Input
...
//           <div>
//             <Label className="text-green-800 font-medium flex items-center">
//               <Tag className="h-5 w-5 mr-2" /> Duration
//             </Label>
//             <Input
...
//           <div>
//             <Label className="text-green-800 font-medium flex items-center">
//               <UserIcon className="h-5 w-5 mr-2" /> Participants
//             </Label>
//             <Input
...
//               disabled={momLoading}
//             >
//               {momLoading ? 'Submitting...' : isEditMode ? 'Update MoM' : 'Submit MoM'}
//             </Button>
//           </div>
//         </div>
//       )}
...
//         meetingId: meeting?.meetingId || '',
//       });
//       setIsEditMode(true); // Create mode if no MoM exists
//     }
...
//           {mom && !isEditMode ? 'Meeting Details Preview' : isEditMode ? 'Edit Minutes of Meeting' : 'Create Minutes of Meeting'}
//         </DialogTitle>
//       </DialogHeader>
